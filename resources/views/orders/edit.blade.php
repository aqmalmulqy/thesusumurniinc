...
<div class="col-lg-8">
    <form method="post" action="/dashboard/product/{{ $Product->slug }}" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('nama_product') is-invalid @enderror" id="nama_product" name="nama_product" required autofocus value="{{ old('nama_product', $Product->nama_product) }}">
          @error('nama_product')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" required value="{{ old('harga', $Product->harga) }}">
          @error('harga')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
